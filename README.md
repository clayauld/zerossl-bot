...
2. Install the ZeroSSL wrapper script
   1. Quick: 
      1. run `bash <(curl -s https://raw.githubusercontent.com/clayauld/zerossl-bot/master/get-zerosslbot.sh)`
      2. Done!
   2. Careful: 
      1. Run `curl -s https://raw.githubusercontent.com/clayauld/zerossl-bot/master/get-zerosslbot.sh > get-zerosslbot.sh`
